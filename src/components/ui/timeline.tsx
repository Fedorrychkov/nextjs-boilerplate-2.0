...
import { AlertCircle, Award, Briefcase, Calendar, Check, Clock, GraduationCap, Heart, MapPin, MessageSquare, User, X } from 'lucide-react'
...
const timelineIconVariants = cva('flex h-6 w-6 shrink-0 items-center justify-center rounded-full border-2 bg-background text-xs font-medium', {
  variants: {
    status: {
