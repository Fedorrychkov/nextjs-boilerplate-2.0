  ...
  return (
    <div>
      ...
      >
        ...
        {prefix && (
          <span className={clsx(`inline-flex absolute pointer-events-none duration-150 ${size}IconContainer`, size === 'xsmall' ? 'left-[5px]' : 'left-3')}>
            {prefix}
          </span>
        )}
        <span className={clsx(`inline-flex absolute pointer-events-none duration-150 ${size}IconContainer`, size === 'xsmall' ? 'right-[5px]' : 'right-3')}>
