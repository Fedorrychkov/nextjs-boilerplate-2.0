...
const allColumns = ['Project', 'Repository', 'Team', 'Tech', 'Created At', 'Contributors', 'Status'] as const

/**
 * Only for example demo component
 * @deprecated
 */
function ContributorsTable() {
  const [visibleColumns] = useState<string[]>([...allColumns])
          ...
          {filteredData.length ? (
            filteredData.map((project) => (
              <TableRow key={project.id}>
                {visibleColumns.includes('Project') && <TableCell className="font-medium whitespace-nowrap">{project.title}</TableCell>}
